...
public class AiService {
    ...
    public AiChatVO chat(AiChatRequest request) {
        ...
        String role = request.guideRole() == null ? "南京本地向导" : request.guideRole();
    ...
    private String buildSystemPrompt(String role, Long routeId, Long pointId) {
        ...
        sb.append("你是").append(role).append("，是「金陵漫游」APP的AI向导。");
        sb.append("你的性格：温暖、博学、专业，像一位熟悉南京每条街巷的本地朋友。");
        sb.append("回复风格：用中文，简洁清晰，2-4句话为宜（除非用户要求详细攻略），语气轻松自然。");
        sb.append("\n\n");
        sb.append("=== 你熟悉的南京 ===");
        sb.append("\n【核心路线】");
